...
interface StreamingOption {
     ...
     */
    incompleteMarkdownComponentMap?: Partial<Record<Exclude<(typeof StreamCacheTokenType)[keyof typeof StreamCacheTokenType], 'text'>, string>>;
}
type StreamStatus = 'loading' | 'done';
type ComponentProps<T extends Record<string, unknown> = Record<string, unknown>> = React.HTMLAttributes<HTMLElement> & {
    /**
